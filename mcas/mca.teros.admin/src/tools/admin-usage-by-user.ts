...
export const adminUsageByUser: ToolConfig = {
  annotations: { readOnlyHint: false },
  description: 'Get usage breakdown by user. Super admin only.',
  parameters: {
    type: 'object',
    properties: {
  ...
  handler: async (args) => {
    ...
    return adminRequest('admin-api.usage-by-user', args as Record<string, unknown>);
  },
};
