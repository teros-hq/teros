...
export const adminAccessGrant: ToolConfig = {
  annotations: { readOnlyHint: false, alwaysAsk: true },
  description: 'Grant an agent access to an app. Super admin only.',
  parameters: {
    type: 'object',
    properties: {
  ...
  handler: async (args) => {
    ...
    return adminRequest('admin-api.access-grant', args as Record<string, unknown>);
  },
};
