...
// Definiciones de las 8 tools (servidas por ListToolsRequestSchema)
// biome-ignore-all: extraído 1:1 del index.ts original (TER-503)
export const TOOLS = [
      {
        name: 'get-current',
...
/**
 * Dispatcher de tool calls — extraído 1:1 del handler de
 * CallToolRequestSchema (TER-503; importar index.ts conecta el transport).
 */
